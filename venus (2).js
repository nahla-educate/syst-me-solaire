...
const texture = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/venusmapthumb.jpg')
const texturee = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/venusmapthumb.jpg')
...
//texture Cloud
const textureCloud = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/venusmapthumb.jpg')
// cloud
