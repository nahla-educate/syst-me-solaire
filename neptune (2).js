...
const texture = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/neptunemapthumb.jpg')
const texturee = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/neptunemapthumb.jpg')
...
//texture Cloud
const textureCloud = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/neptunemapthumb.jpg')
// cloud
