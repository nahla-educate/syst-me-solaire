...
const texture = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/mercurymapthumb.jpg')
const texturee = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/mercurymapthumb.jpg')
...
//texture Cloud
const textureCloud = new THREE.TextureLoader().load('http://planetpixelemporium.com/images/mappreviews/mercurymapthumb.jpg')
// cloud
