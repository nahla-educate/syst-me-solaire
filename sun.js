...
const texture = new THREE.TextureLoader().load('https://nguyen.univ-tln.fr/share/OpenGL/preview_sun.jpg')
const texturee = new THREE.TextureLoader().load('https://nguyen.univ-tln.fr/share/OpenGL/preview_sun.jpg')
...
//texture Cloud
const textureCloud = new THREE.TextureLoader().load('https://nguyen.univ-tln.fr/share/OpenGL/preview_sun.jpg')
// cloud
