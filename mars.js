...
const texture = new THREE.TextureLoader().load('http://planetpixelemporium.com/download/download.php?mars_1k_color.jpg')
const texturee = new THREE.TextureLoader().load('http://planetpixelemporium.com/download/download.php?mars_1k_color.jpg')
...
//texture Cloud
const textureCloud = new THREE.TextureLoader().load('http://planetpixelemporium.com/download/download.php?mars_1k_color.jpg')
// cloud
